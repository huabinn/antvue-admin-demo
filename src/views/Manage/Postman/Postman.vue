		...
		<a-card :bordered="false" :loading="loading">
			...
			<div class="card-content">
				<div class="button-group">
					...
					<a-button type="primary" style="width: 88px" @click="newDepartment">新增</a-button>
				</div>
				<a-table
				...
				>
					<template #operation="{ record }">
						<a-space class="operate">
							<a @click="editDepartment(record.key)">编辑</a>
...
export default defineComponent({
	...
	setup() {
		 ...
		 */
		const newDepartment = () => { 
			router.push("/manage/postman/newpost")
		}
		/**
		 * 编辑发放
		 * @param {number} key 
		...
		const editDepartment = key => { 
			console.log('key', key);
			router.push("/manage/postman/editpost")
		}
		/**
		 * 暂停操作
		 * @param {number} key 
